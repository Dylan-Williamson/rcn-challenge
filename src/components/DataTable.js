...
const DataTable = () => {
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: '1600px', marginLeft: 'auto', marginRight: 'auto' }}>
      <input className="h-8 outline-transparent w-1/3 max-w-xs rounded-md drop-shadow-lg fixed right-10 top-4 z-10 p-2 font-teko" type="text" placeholder="Search" onChange={handleSearch} value={search}/>
